rm(list=ls())
setwd("C:/Users/pbanerjee/Documents/MI_Simulation/AOAS/miss_50_p_10")
...
############################
### Test on full dataset without any missing observations
############################
...
non_miss_dat = sim.data(gen.size = 100, n = 200, rho = 0.2, sig = 1, beta.coef = beta.vec, miss.type = "Non", corr.type = "linear")
...
write.csv(tab, "result_MI_sim_fulldata_0.2.csv")
...
non_miss_dat = sim.data(gen.size = 100, n = 200, rho = 0.5, sig = 2, beta.coef = beta.vec, miss.type = "Non", corr.type = "linear")
...
write.csv(tab, "result_MI_sim_fulldata_0.5.csv")
...
non_miss_dat = sim.data(gen.size = 100, n = 200, rho = 0.8, sig = 2, beta.coef = beta.vec, miss.type = "Non", corr.type = "linear")
...
write.csv(tab, "result_MI_sim_fulldata_0.8.csv")
